<template>
  <section class="alert-banner">
    ...
    <div class="alert-button-container">
      <a v-if="$page.frontmatter.alert_link && $page.frontmatter.alert_link.indexOf('http') === 0" :href="$page.frontmatter.alert_link" class="alert-button slide">{{$page.frontmatter.alert_label || 'Read More'}} ➜</a>
