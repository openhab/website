...
First, be sure to check that your system has the necessary [prerequisites](./installation/index.html#prerequisites).
...
4.  Point your browser to `http://localhost:8080`.
    You should be looking at the openHAB [package selection page](./configuration/packages.html).
    When you've selected an appropriate package, this page will contain the [UI](./addons/uis.html) selection screen.
