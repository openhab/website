...
This might be useful if you're [coming from openHAB 1.x](/tutorials/migration.html) for example.
...
If you're new to openHAB, then you should checkout the [beginner's tutorial](/tutorials/beginner/1sttimesetup.html)!
...
With openHAB 2 you can also [use the Karaf console](/administration/logging.html#karaf-console) to have a colored glance at the logging information.
...
The [Eclipse SmartHome Designer](/configuration/editors.html#eclipse-smarthome-designer) software does also depend on a mounted share to access the openHAB configuration files.
