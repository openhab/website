...
including [BasicUI](/addons/uis/basic/readme.html),
...
For easy editing of sitemap definition files, we suggest to use on of the [openHAB supporting editors](/configuration/editors.html).
...
Data presented by Sitemap elements will almost always originate from a referenced [Item}(/configuration/items.md).
...
All Sitemap elements can be configured to be hidden, color highlighted or to have a [dynamic icon](/items.md#icons-dynamic), depending on certain Item states.
...
- Present a special icon, depending on the state of an item (a [dynamic icon](/items.md#icons-dynamic))
...
![battery-0](/addons/iconsets/classic/icons/battery-0.png "battery-0")
![battery-30](/addons/iconsets/classic/icons/battery-30.png "battery-30")
![battery-60](/addons/iconsets/classic/icons/battery-60.png "battery-60")
![battery-100](/addons/iconsets/classic/icons/battery-100.png "battery-100")
