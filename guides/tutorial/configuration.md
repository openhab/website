...
We left at the [start page](/tutorials/beginner/1sttimesetup.html) before showing you the differences of the UIs.
...
**More information about the Zwave binding and the other available bindings can be found [on the bindings page of the user manual](/addons/bindings.html)!**
...
[On the next page](/tutorials/beginner/sitemap.html), we will define a sitemap to create your own view of things an items.
