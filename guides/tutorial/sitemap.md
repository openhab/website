...
See the linux installation instructions for the [file locations](/installation/linux.html#file-locations) specific to linux, or the Windows [file locations](/installation/windows.html#file-locations) specific to Windows.
...
You can find a detailled overview of the different item types [here](/configuration/items.html)
...
**More information about available icons can be found [here](/configuration/items.html#icons)**
...
On the next page, we want to create a simple rule. Please proceed to [the rules page](/tutorials/beginner/rules.html)
