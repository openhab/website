---
title: Mac OS X
source: https://github.com/openhab/openhab-docs/blob/gh-pages/installation/macosx.md
---
...
Without closing the terminal, open your favorite web browser and type the following URL: [http://localhost:8080](http://localhost:8080), you should see the openHAB welcome screen, and you're all set to [using openHAB](/docs/tutorial/1sttimesetup.html).
