---
title: Windows
source: https://github.com/openhab/openhab-docs/blob/gh-pages/installation/windows.md
---
...
First, be sure to check that your system has the necessary [prerequisites](/docs/installation/index.html#prerequisites).
...
4.  Point your browser to `http://localhost:8080`.
    You should be looking at the openHAB [package selection page](/docs/configuration/packages.html).
    When you've selected an appropriate package, this page will contain the [UI](/docs/addons/uis.html) selection screen.
