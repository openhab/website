---
title: Configuration
source: https://github.com/openhab/openhab-docs/blob/gh-pages/configuration/index.md
---
...
- [Bindings](/docs/addons/bindings.html) - The numerous Add-ons to communicate with your devices
