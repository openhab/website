---
title: Persistence
source: https://github.com/openhab/openhab-docs/blob/gh-pages/configuration/persistence.md
---
...
A complete list of supported persistence add-ons may be found in the [persistence](/docs/addons/persistence.html) section of the on-line openHAB documentation.

Please refer to the [available persistence service add-on](/docs/addons/persistence.html) documentation for your selected persistence add-on for configuration instructions.
