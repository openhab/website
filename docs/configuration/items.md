---
title: Items
source: https://github.com/openhab/openhab-docs/blob/gh-pages/configuration/items.md
---
...
1.  Through [Paper UI](/docs/addons/uis/paper/readme.html).
...
Graphical UIs will display the label text when the Item is included, e.g. in [Basic UI](/docs/addons/uis/basic/readme.html) in a [Sitemap](/docs/configuration/sitemaps.html) definition.
...
*N.B.*  Many openHAB users find that it can be very useful to use [Persistence](/docs/addons/persistence.html) and [System started](/docs/configuration/rules-dsl.html#system-based-triggers) rules so that their systems behaves in a predictable way after an openHAB restart.
...
openHAB provides a set of [classic icons](/docs/addons/iconsets/classic/readme.html) by default.
...
These relationships can be exploited in [Sitemaps](/docs/configuration/sitemaps.html) or in [automation rules](/docs/configuration/rules-dsl.html) to navigate through the hierarchically organized Items or to perform computations and updates on subsets of similar Items.
...
See the [Hue Emulation](/docs/addons/ios/hueemulation/readme.html) or [HomeKit Add-on](/docs/addons/ios/homekit/readme.html) documentation for more details.

### Binding Configuration

One of the greatest strengths of an openHAB automation system is the sheer number of devices you can interact with.
See "[currently available Bindings](/docs/addons/bindings.html)" for a list of available Bindings.
...
The information required for each binding is specified in the configuration information provided for each of the available [Bindings](/docs/addons/bindings.html).
...
openHAB2 introduces the concept of [Things and Channels](/docs/concepts/things.html).
...
See the [Bindings](/docs/addons/bindings.html) configuration section for more information on how to discover or manually define Things for a given Binding.
...
The second example shows a common use case for the [expire Binding](/docs/addons/bindings/expire1/readme.html)
