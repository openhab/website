---
source: https://github.com/openhab/openhab-docs/blob/gh-pages/tutorials/beginner/rules.md
---
...
**More information on rules can be found [in the rules section of the user manual!](/docs/configuration/rules-dsl.html)**
