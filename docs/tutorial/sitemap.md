---
source: https://github.com/openhab/openhab-docs/blob/gh-pages/tutorials/beginner/sitemap.md
---
...
See the linux installation instructions for the [file locations](/docs/installation/linux.html#file-locations) specific to linux, or the Windows [file locations](/docs/installation/windows.html#file-locations) specific to Windows.
...
You can find a detailled overview of the different item types [here](/docs/configuration/items.html)
...
**More information about available icons can be found [here](/docs/configuration/items.html#icons)**
...
On the next page, we want to create a simple rule. Please proceed to [the rules page](/docs/tutorial/rules.html)
